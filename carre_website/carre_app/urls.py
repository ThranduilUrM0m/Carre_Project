...
urlpatterns = [
	...
	url('^(?P<collection_id>[0-9]+)/index_collection/$', views.index_collection, name='index_collection'),
	url('^index_adressendtel/$', views.index_adressendtel, name='index_adressendtel'),
	url('^(?P<categorie_id>[0-9]+)/index_categorie/$', views.index_categorie, name='index_categorie'),
